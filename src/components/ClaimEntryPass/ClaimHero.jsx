      ...
      <div className='flex items-center justify-center w-full'>
        <div className='flex flex-col items-center justify-center w-3/4 gap-5 px-4 py-8 m-auto bg-gray-800 border-2 border-orange-700 rounded-lg'>
          <div className='flex flex-col items-center justify-center p-4  bg-gradient-to-r from-[#FF3503] to-yellow-500 rounded-lg'>
            ...
            <p className='text-sm'>
              Entrypasses are the key to unlocking new features and earning
              Blazpoints on the Blazpay platform. Users will have the chance to
              test new features and enhancements ahead of time. Being a part of
              shaping the future of the platform and experiencing a sneak peek
              of what's to come is an incredibly empowering experience.
            </p>
          </div>
        </div>
      </div>
